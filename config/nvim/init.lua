...
-- Obsidian keymaps (using <leader>n for "notes")
...
vim.keymap.set("n", "<leader>nd", "<cmd>ObsidianToday<CR>", { desc = "Open today's note (daily)" })
...
vim.keymap.set("n", "<leader>ng", "<cmd>ObsidianTags<CR>", { desc = "Show tags" })
...
vim.keymap.set("v", "<leader>nl", "<cmd>ObsidianLinkNew<CR>", { desc = "Link to new note" })
vim.keymap.set("v", "<leader>ne", "<cmd>ObsidianExtractNote<CR>", { desc = "Extract to new note" })
